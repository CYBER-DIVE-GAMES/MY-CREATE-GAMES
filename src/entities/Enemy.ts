...
export const ENEMY_CONFIGS: Record<string, Omit<EnemyConfig, 'x' | 'y'>> = {
  ...
  dancing_doll: { hp: 100, speed: 100, xp: 10,  youkakuDrop: 1, youkakuChance: 0.3, color: 0xff88ff, size: 14, movePattern: 'zigzag',            firePattern: 'rapid3',       fireInterval: 900,  bulletDamage: 5  },
  shadow_spider:{ hp: 350, speed: 160, xp: 35,  youkakuDrop: 2, youkakuChance: 0.5, color: 0x442266, size: 22, movePattern: 'cross_horizontal',  firePattern: 'radial8_rot',  fireInterval: 900,  bulletDamage: 7  },
  blood_cherry: { hp: 300, speed: 70,  xp: 30,  youkakuDrop: 2, youkakuChance: 0.5, color: 0xff4488, size: 20, movePattern: 'straight',          firePattern: 'fan9_down',    fireInterval: 2000, bulletDamage: 8  },
  gate_guardian:{ hp: 800, speed: 110, xp: 100, youkakuDrop: 3, youkakuChance: 1.0, color: 0x664422, size: 32, movePattern: 'horizontal_top',    firePattern: 'large3',       fireInterval: 2800, bulletDamage: 15 },
};
